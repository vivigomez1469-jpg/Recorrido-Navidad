...
var texture1 = new THREE.TextureLoader().load("./image/reg3.jpg");
...
var material16 = new THREE.MeshLambertMaterial({
    color: 0x9C1616, side: THREE.DoubleSide
});
...
var material17 = new THREE.MeshLambertMaterial({
    color: 0x48ACB5, side: THREE.DoubleSide
});
...
var reg6 = new THREE.Group();
        reg6.add(mesh15,mesh16,mesh17,mesh18,mesh19,mesh20,mesh21,mesh22,mesh23,mesh24,mesh25);
        reg6.position.set(x,y,z);
        return reg6;
}