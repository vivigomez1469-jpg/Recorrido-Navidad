...
var material15 = new THREE.MeshLambertMaterial({
    color: 0xE3AD30, side: THREE.DoubleSide
});
...
var material16 = new THREE.MeshLambertMaterial({
    color: 0x8F7029, side: THREE.DoubleSide
});
...
var reg3 = new THREE.Group();
        reg3.add(mesh15,mesh16,mesh17,mesh18,mesh19,mesh20,mesh21,mesh22,mesh23,mesh24,mesh25);
        reg3.position.set(x,y,z);
        return reg3;
}