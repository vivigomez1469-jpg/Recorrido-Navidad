...
var texture1 = new THREE.TextureLoader().load("./image/reg4.jpg");
...
var material16 = new THREE.MeshLambertMaterial({
    color: 0xD69C20, side: THREE.DoubleSide
});
...
var material17 = new THREE.MeshLambertMaterial({
    color: 0xE80C0C, side: THREE.DoubleSide
});
...
var reg7 = new THREE.Group();
        reg7.add(mesh15,mesh16,mesh17,mesh18,mesh19,mesh20,mesh21,mesh22,mesh23,mesh24,mesh25);
        reg7.position.set(x,y,z);
        return reg7;
}