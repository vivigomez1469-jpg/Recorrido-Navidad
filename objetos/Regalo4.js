...
var texture1 = new THREE.TextureLoader().load("./image/reg.jpg");
...
var material16 = new THREE.MeshLambertMaterial({
    color: 0xB52828, side: THREE.DoubleSide
});
...
var material17 = new THREE.MeshLambertMaterial({
    color: 0x293C8F, side: THREE.DoubleSide
});
...
var reg4 = new THREE.Group();
        reg4.add(mesh15,mesh16,mesh17,mesh18,mesh19,mesh20,mesh21,mesh22,mesh23,mesh24,mesh25);
        reg4.position.set(x,y,z);
        return reg4;
}