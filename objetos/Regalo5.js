...
var texture1 = new THREE.TextureLoader().load("./image/reg2.jpg");
...
var material16 = new THREE.MeshLambertMaterial({
    color: 0x265C4E, side: THREE.DoubleSide
});
...
var material17 = new THREE.MeshLambertMaterial({
    color: 0xFCD360, side: THREE.DoubleSide
});
...
var reg5 = new THREE.Group();
        reg5.add(mesh15,mesh16,mesh17,mesh18,mesh19,mesh20,mesh21,mesh22,mesh23,mesh24,mesh25);
        reg5.position.set(x,y,z);
        return reg5;
}