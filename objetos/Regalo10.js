...
var texture1 = new THREE.TextureLoader().load("./image/reg5.jpg");
var material15 =new THREE .MeshLambertMaterial({map:texture1,side:THREE.DoubleSide})
...
var material16 = new THREE.MeshLambertMaterial({
    color: 0x89DDE0, side: THREE.DoubleSide
});
...
var material17 = new THREE.MeshLambertMaterial({
    color: 0x3F6099, side: THREE.DoubleSide
});
...
var reg10 = new THREE.Group();
        reg10.add(mesh15,mesh16,mesh17,mesh18,mesh19,mesh20,mesh21,mesh22,mesh23,mesh24,mesh25);
        reg10.position.set(x,y,z);
        return reg10;
}