...
var material15 = new THREE.MeshLambertMaterial({
    color: 0x8F8ADE, side: THREE.DoubleSide
});
...
var material16 = new THREE.MeshLambertMaterial({
    color: 0x2D2978, side: THREE.DoubleSide
});
...
var material17 = new THREE.MeshLambertMaterial({
    color: 0xE16BE3, side: THREE.DoubleSide
});
...
var reg8 = new THREE.Group();
        reg8.add(mesh15,mesh16,mesh17,mesh18,mesh19,mesh20,mesh21,mesh22,mesh23,mesh24,mesh25);
        reg8.position.set(x,y,z);
        return reg8;
}