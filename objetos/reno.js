...
var material13 = new THREE.MeshLambertMaterial({
    color: 0xED1B05, side: THREE.DoubleSide
});
...
var reno = new THREE.Group();
    reno.add(mesh1,mesh2,mesh3,mesh4,mesh5,mesh6, mesh7, mesh8, mesh9, mesh10, mesh11, mesh12, mesh13, mesh14, mesh15, mesh16, mesh17,mesh18,mesh19,mesh20,mesh21,mesh22,mesh23,mesh24,);
        reno.position.set(x,y,z);
        return reno;
}
