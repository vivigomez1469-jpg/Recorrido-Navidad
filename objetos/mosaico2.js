...
var texture = new THREE.TextureLoader() .load("./image/foto2.jpg");
...
var mosaico2 = new THREE.Group();
    mosaico2.add(mesh1,mesh2,mesh3,mesh4,mesh5,mesh6, mesh7, mesh8, mesh9,);
        mosaico2.position.set(x,y,z);
        return mosaico2;
}
